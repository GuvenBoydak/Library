    ...
    public class RegisterInputValidator : AbstractValidator<RegisterInput>
    {
        public RegisterInputValidator()
        {
            RuleFor(x => x.FirstName)
                ...
                .MaximumLength(50).WithMessage("FirstName must be a maximum of 50 characters.")
                .Matches(@"^[a-zA-ZiİçÇşŞğĞÜüÖöIıUuOo\s@]*$").WithMessage("Just Enter Letters.");
            ...
            RuleFor(x => x.PhoneNumber)
                .Matches("^[0-9]+$").WithMessage("Just Enter Numbers");
